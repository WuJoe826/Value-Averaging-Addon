...
All notable changes to the value-averaging-addon addon will be documented in this file.
...
### Added
- Initial release of value-averaging-addon addon
...
### Features
- A Wealthfolio addon for value-averaging-addon
